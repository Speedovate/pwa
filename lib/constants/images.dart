class AppImages {
  ...
  static const cashless = "${baseUrl}cashless.png";
  static const security = "${baseUrl}security.png";
  static const convenience = "${baseUrl}convenience.png";
  static const overcharging = "${baseUrl}overcharging.png";
  static const transparency = "${baseUrl}transparency.png";
}
