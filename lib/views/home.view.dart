...
class _HomeViewState extends State<HomeView>
  ...
  bool _showDrawerContent = false;
  final Duration _drawerAnimationDuration = const Duration(milliseconds: 100);

  void _toggleDrawer() {
    if (_drawerOpen) {
      setState(() {
        _showDrawerContent = false;
        _drawerOpen = false;
      });
    } else {
      setState(() {
                  ...
                  if (_drawerOpen)
                    GestureDetector(
                      ...
                      child: AnimatedOpacity(
                        ...
                        opacity: _showDrawerContent ? 0.5 : 0.0,
                        child: Container(
                          color: Colors.black,
                        ),
                      ),
                              ...
                              children: [
                                ...
                                ListTileWidget(
                                  ...
                                  title: const Text("Assistance",
                                      style:
                                          TextStyle(color: Color(0xFF030744))),
                                  onTap: () {
                                    Get.back();
