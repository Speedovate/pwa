                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: gVehicleTypes.isEmpty || mapUnavailable
                                    ? Colors.red.shade50
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                            height: 1.05,
                                            fontSize: 13,
                                            fontWeight: gVehicleTypes.isEmpty ||
                                                    mapUnavailable
                                                ? FontWeight.w500
                                                : null,
                                            color: const Color(0xFF030744),
                            ...
                            child: SizedBox(
                              ...
                              child: Material(
                                color: vm.selectedAddress == null
                                    ? const Color(0xFF030744).withOpacity(0.25)
                                    : const Color(0xFF007BFF),
                                borderRadius: const BorderRadius.all(
                                  Radius.circular(8),
                                ),
                                child: Ink(
                                  child: ActionButton(
                                    onTap: () {
                                      ...
                                      if (vm.selectedAddress != null) {
                                        if (widget.isPickup) {
                                          pickupAddress = vm.selectedAddress;
                                        } else {
                                          dropoffAddress = vm.selectedAddress;
                                        }
